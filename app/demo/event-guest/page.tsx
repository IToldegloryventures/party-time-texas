          ...
          <div className="rounded-lg border border-gray-800 bg-gray-900 p-6 lg:col-span-2">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-start justify-between border-b border-gray-800 pb-3"
                >
                  <div>
        ...
        <div className="mt-8 rounded-lg border border-gray-800 bg-gray-900 p-6">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            {[1, 2, 3, 4, 5, 6, 7, 8].map(idx => (
              <div
                key={idx}
                className="flex aspect-square items-center justify-center rounded-lg border border-gray-700 bg-gray-800"
              >
                <svg
          ...
          <p className="mt-3 text-xs text-gray-500">
            234 photos uploaded • 43 uploads today
          </p>
        </div>
