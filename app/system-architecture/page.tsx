      ...
      <div className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {/* NFC Device Manager */}
            <div className="group rounded-xl border border-orange-900/50 bg-gradient-to-br from-orange-950/50 to-orange-900/20 p-6 transition-all hover:border-orange-700/80 hover:bg-orange-950/40">
            ...
            {/* Event Management */}
            <div className="group rounded-xl border border-red-900/50 bg-gradient-to-br from-red-950/50 to-red-900/20 p-6 transition-all hover:border-red-700/80 hover:bg-red-950/40">
            ...
            <div className="group rounded-xl border border-pink-900/50 bg-gradient-to-br from-pink-950/50 to-pink-900/20 p-6 transition-all hover:border-pink-700/80 hover:bg-pink-950/40">
            ...
            {/* Task Management */}
            <div className="group rounded-xl border border-yellow-900/50 bg-gradient-to-br from-yellow-950/50 to-yellow-900/20 p-6 transition-all hover:border-yellow-700/80 hover:bg-yellow-950/40">
              <div className="mb-4 inline-flex rounded-lg bg-yellow-500/20 p-3">
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div className="group rounded-xl border border-purple-900/50 bg-gradient-to-br from-purple-950/50 to-purple-900/20 p-8 transition-all hover:border-purple-700/80 hover:bg-purple-950/40">
              <div className="mb-6 inline-flex rounded-lg bg-purple-500/20 p-3">
                <svg className="h-6 w-6 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="group rounded-xl border border-indigo-900/50 bg-gradient-to-br from-indigo-950/50 to-indigo-900/20 p-8 transition-all hover:border-indigo-700/80 hover:bg-indigo-950/40">
              <div className="mb-6 inline-flex rounded-lg bg-indigo-500/20 p-3">
        ...
        <div className="mb-32">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div className="rounded-xl border border-emerald-900/50 bg-gradient-to-br from-emerald-950/50 to-emerald-900/20 p-8">
              <div className="mb-6 inline-flex rounded-lg bg-emerald-500/20 p-3">
            ...
            <div className="rounded-xl border border-teal-900/50 bg-gradient-to-br from-teal-950/50 to-teal-900/20 p-8">
              <div className="mb-6 inline-flex rounded-lg bg-teal-500/20 p-3">
            ...
            <div className="rounded-xl border border-amber-900/50 bg-gradient-to-br from-amber-950/50 to-amber-900/20 p-8">
              <div className="mb-6 inline-flex rounded-lg bg-amber-500/20 p-3">
