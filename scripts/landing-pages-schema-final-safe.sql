-- Landing Pages Database Schema Setup (Final Safe Version)
...
-- Drop ALL existing policies safely to avoid conflicts
...
-- Create granular RLS policies for landing_page_scans
...
-- Create function for scan count updates
